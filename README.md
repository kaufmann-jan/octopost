...
`sectionalForces` and `waveBuoy` also attach positional metadata to the
returned DataFrame via `DataFrame.attrs`:
- `sectionalForces(...).attrs["coordinates"]`
- `waveBuoy(...).attrs["locations"]`
